...
exports.isReplacementType = isReplacementType;
...
const Replacement_1 = __nccwpck_require__(3069);
const ReplacementType_1 = __nccwpck_require__(7018);
/**
...
class Inputs {
    ...
    static getVersion() {
        const input = (0, core_1.getInput)('version', { required: true });
    ...
    static getFilesToUpdate() {
        const input = (0, core_1.getInput)('files-to-update', { required: true });
        return this.splitTrimIgnoreEmpty(input, /[,\n]/);
    }
    static getReplacements() {
        const input = (0, core_1.getInput)('replacements', { required: false });
        const configs = [];
        for (const replacement of this.splitTrimIgnoreEmpty(input, ',')) {
            if ((0, Replacement_1.isReplacement)(replacement)) {
    ...
    static getReplacementConfig(replacement) {
        const typeInput = (0, core_1.getInput)(replacement + '-type', { required: false }).trim();
        if (typeInput !== '' && !(0, ReplacementType_1.isReplacementType)(typeInput)) {
        ...
        const matchInput = (0, core_1.getInput)(replacement + '-match', { required: false }).trim();
    ...
    static getOptionalBooleanInput(name) {
        if ((0, core_1.getInput)(name, { required: false }) === '') {
            return false;
        }
...
const ExactReplacer_1 = __nccwpck_require__(2579);
const NumberReplacer_1 = __nccwpck_require__(7200);
const StringReplacer_1 = __nccwpck_require__(5736);
/**
...
const Replacer_1 = __nccwpck_require__(6027);
/**
...
const LanguageSpecificReplacer_1 = __nccwpck_require__(7779);
/**
...
const VersionInfoFile_1 = __nccwpck_require__(9228);
/**
...
const Coordinator_1 = __nccwpck_require__(1175);
const Inputs_1 = __nccwpck_require__(1298);
const ReplacementValues_1 = __nccwpck_require__(850);
const ReplacerFactory_1 = __nccwpck_require__(4013);
const ValidatePerformedReplacements_1 = __nccwpck_require__(298);
const VersionInfoFileLoader_1 = __nccwpck_require__(2324);
